...
We use categories for a special purpose in our implementation: '''categories are how Semantic Forms knows which form to present to a user to edit the page.''' If you look at a category's documentation page (for example [[Category:CSS_Properties|//webplatform.org/docs/Category:CSS_Properties]] ) you'll see that it includes markup that specifies which form those pages should use. 
