...
=MediaStream API=
Describe the MediaStream API. Provide links to the appropriate API objects, in this example: LocalMediaStream, MediaStream, </nowiki><br />
<nowiki>MediaStreamTrack, and MediaStreamTrackList.
=PeerConnection API=
