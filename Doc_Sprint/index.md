...
Also, there are two ways to read this document. You could start with the [[#General Considerations|General Considerations]] section or jump down to the more comprehensive [[#Timeline|Timeline]] section, which puts things in order and links back to the considerations wherever needed.
...
*'''Security:''' Make it clear that everybody needs to mind his/her own belongings. If attendees need to sign in to enter the building, make sure you understand and communicate the process and, if necessary, hire a person to receive and authorize attendees at the front door; a [https://www.taskrabbit.com/ TaskRabbit] works well for this. 
...
*'''Directions:''' Pick a location that can be reached easily. If it is not easily accessible, or has limitations like no parking spaces, be sure to communicate before hand (see [[#Registration and Communications|Registration and Communications]]). Provide a map to the event, with options for public transport, if possible.
...
Be sure to use the WebPlatfor.org [http://www.webplatform.org/logo/ logo page] in creating designs with our logo.
