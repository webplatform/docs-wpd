...
Each role name states are defined in an ''sls'' file in <code>/srv/salt/roles</code> and from there, you’ll see any rsync scripts it uses to copy code the salt master hosts in ''/srv/code/foo/repo''. 
