...
===Half-hour tasks===
* '''Add new examples''' Provide more examples that illustrate techniques or describe good use of technologies. Look for articles where additional examples would be helpful in [[WPD:Getting_Started/examples/css|CSS pages]] or [[WPD:Getting_Started/examples/api|API pages]].
