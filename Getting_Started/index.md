...
'''public-webplatform@w3.org''' is the mailing list we use to coordinate on larger issues, like article organization, changes to common templates or forms, or setting new norms. It's also where we announce things like upcoming hackathons (which everyone is welcome to join). You can join [http://lists.w3.org/Archives/Public/public-webplatform/ here]. You do '''not''' need a W3C account to join or send messages.
