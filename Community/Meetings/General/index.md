...
* Patrick to give us optimal day and time to launch a blog post.
* Analytics TF: set up page optimization in the next two weeks.
* Project area leads should join next week's call so we can define what it means to be head of a task force.
