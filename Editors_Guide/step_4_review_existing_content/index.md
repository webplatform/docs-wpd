...
While you're reviewing the content, take a sharp look at the topics and topic cluster tags assigned. In many cases these may not be applied properly, and it's difficult to tell if there is a problem. See [[WPD:Editors_Guide/step_6_author_or_upload_new_content#Topics_and_topic_clusters]] for guidance.
{{Notes_Section}}
{{Topics}}
