...
## <span>Step 5. 기존에 작성된 콘텐츠를 수정하기</span>

### <span>미디어위키 문법 배우기</span>
...
### <span>글에는 설명 글 제목이 있는지 확인해 주세요.</span>
...
### <span>정확히 설명될 수 있도록 섹션 제목을 업데이트 하기</span>
...
### <span>코드를 나타낼때 적절한 구문 강조를 사용하세요.</span>
...
### <span>개념을 설명하기 위해 이미지를 추가하기</span>
...
### <span>글은 벤더(vendor) 중립성을 가져야 합니다.</span>
...
### <span>중립적인 의견을 사용하는 작성자 콘텐트</span>
...
### <span>위키 페이지의 포맷팅과 스타일링에 대한 논의에 참여하기</span>
