 ...
 <div class="long-topic"> 
    ...
    <div class="inner">
        <h3>[[WPD:Editors_Guide/step_5_update_existing_content|Update existing content]]</h3>
            ...
            <li>[[http://docs.webplatform.org/wiki/WPD:Manual_Of_Style/Sample_best_practices Edit code samples]]</li>
        </ul>
     </div>
  </div>
 ...
 <div class="long-topic"> 
    ...
    <div class="inner">
        <h3>[[WPD:Editors_Guide/step_6_author_or_upload_new_content|Add new content]]</h3>
            ...
            <li>[[http://docs.webplatform.org/wiki/WPD:Manual_Of_Style/Sample_best_practices Create code samples]]</li>
        </ul>
     </div>
  </div>
