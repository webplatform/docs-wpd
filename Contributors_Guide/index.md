...
<div class="topic-container">
  <div class="long-topic">
      ...
      <div class="inner"  style='border:1px solid #b8860b; padding:5px 5px 5px 5px; border-radius:5px; min-height:125px'>
        <h3 style='min-height:25px'>[http://docs.webplatform.org/w/index.php?title=Special:UserLogin&returnto=WPD:Editors+Guide Register]</h3>
        <ul>
 ...
 <div class="long-topic"> 
     <div class="place-holder"></div>
    <div class="inner"  style='border:1px solid #b8860b; padding:5px 5px 5px 5px; border-radius:5px; min-height:125px'>
        <h3 style='min-height:25px'>[[WPD:Editors_Guide/step_2_communicate_with_the_online_community| Communicate]]</h3>
            <ul>
 ...
 <div class="long-topic"> 
     <div class="place-holder"></div>
    <div class="inner"  style='border:1px solid #b8860b; padding:5px 5px 5px 5px; border-radius:5px; min-height:125px'>
        <h3 style='min-height:25px'>[[WPD:Editors_Guide/step_3_become_familiar_with_the_wiki|Working the wiki]]</h3>
            <ul>
 ...
 <div class="long-topic"> 
     <div class="place-holder"></div>
    <div class="inner"  style='border:1px solid #b8860b; padding:5px 5px 5px 5px; border-radius:5px; min-height:125px'>
        <h3 style='min-height:25px'>[[WPD:Editors_Guide/step_4_review_existing_content|Review existing content]]</h3>
            <ul>
 ...
 <div class="long-topic"> 
     <div class="place-holder"></div>
    <div class="inner"  style='border:1px solid #b8860b; padding:5px 5px 5px 5px; border-radius:5px; min-height:125px'>
        <h3 style='min-height:25px'>[[WPD:Editors_Guide/step_5_update_existing_content|Update existing content]]</h3>
            <ul>
