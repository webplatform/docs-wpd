...
These portions of content must be clearly marked in the wikitext with &lt;div class='license-cc-by-sa'&gt;. Those divs may not be removed until the license has [[WPD:Porting_MDN_Content | been converted to the WPD license]]. Any edits inside that box should retain the box.
